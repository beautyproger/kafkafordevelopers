Вам нужно сохранять сообщения в базу на скорости 3000 рпс. На такой скорости ваша текущая база данных не может обеспечить корректную работу ключа идемпотентности.
